...
**Architecture diagrams as plain text.** Ten notations — C4 models, UML-style
...
| `/live`                                                                                                                                                            | **The playground.** One pane that takes any supported text — `.alab` in any of the ten notations, arch-lab JSON, or Mermaid — detects it and renders the matching diagram, and the one page where a canvas gesture is available. Also where any `/live#m=…` share link lands.                                  |
