...
| `/live/gantt/[exampleId]`                                                                                                                                          | A registered example gantt, read-only (`/live/gantt/store-migration`, `/live/gantt/datacentre-move`). Statically generated from the same registry, like every other kind's example route.                                                                                                                       |
