 ...
 *
 * NINE DOCUMENT KINDS, so the copy names no single one. This card used to read
 ...
 *
 * THE FOOTER NAMES THE CAPABILITY, NOT FOUR OF THE NINE KINDS. It used to read
 * "C4 · sequence · flowchart · use case", which was a list two notations out of
 * date and could not be completed: even six names at 28px overflow the 620px
 * copy column, and a card is not a place a list can grow — the eighth
 * notation cost this card one digit, and the ninth cost it another. What replaced it is the
 * thing that IS true of the whole product and was said on no budgeted surface —
 * that a diagram here is written as text and two of the nine canvases answer a
 ...
 * it here would over-claim for the seven notations that answer no gesture. The
