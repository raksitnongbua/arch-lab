...
/**
 * `/live/dict` — a forwarding alias for `/live?d=dict`, minted alongside the ER
 * document type so the sixth kind has the same short, memorable door as
 * `/live/seq`, `/live/flow` and `/live/uc` (`check:seo` and
 ...
 * must keep opening forever. (New Dictionary share links mint against bare `/live`,
