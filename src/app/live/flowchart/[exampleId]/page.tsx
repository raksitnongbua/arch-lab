...
/**
 * `/live/flowchart/[exampleId]` — one registered example flowchart, read-only.
 * The flowchart counterpart of `/live/[modelId]` and
 * `/live/sequence/[exampleId]`, and the destination the demo index links its
 * flowchart cards at.
 *
 ...
 * seed alias is the short `/live/flow`: nothing is ever minted against THIS
 * path — it is a crawlable page a human or a search engine follows a link to,
 * so the readable word beats the four characters. `/live/flow` stays the
...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: { canonical: `/live/flowchart/${exampleId}` },
  };
}
