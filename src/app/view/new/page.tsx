...
export const metadata: Metadata = {
  ...
  description:
    "Edit arch-lab text (.aft) and arch-lab JSON side by side — each pane regenerates the other as you type and the diagram re-renders live. Import Mermaid C4 one-way, copy or download either format, and export the diagram as an image. Everything stays in your browser.",
};
