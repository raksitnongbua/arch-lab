...
export const metadata: Metadata = {
  title: "Use case diagram playground",
...
/**
 * `/view/uc` — a forwarding alias for `/live?d=uc`, kept when the route family
 * was renamed `/live`. A bookmark and typed-URL door for use-case diagrams; nothing was ever minted
 * against it.
 *
 * The family's reasoning — why this cannot be a `redirects()` rule, why it
 * skips `/live/uc` and lands in one hop, and why it is `noindex` with a
 * canonical on `/live` — is on `../page.tsx`.
 */
export default function LegacyViewUcPage(): React.JSX.Element {
