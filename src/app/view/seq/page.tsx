...
/**
 * `/view/seq` — a forwarding alias for `/live?d=seq`, kept when the route family
 * was renamed `/live`. Every sequence share link minted before the playgrounds merged carries this
 * path.
 *
 * The family's reasoning — why this cannot be a `redirects()` rule, why it
 * skips `/live/seq` and lands in one hop, and why it is `noindex` with a
 * canonical on `/live` — is on `../page.tsx`.
 */
export default function LegacyViewSeqPage(): React.JSX.Element {
