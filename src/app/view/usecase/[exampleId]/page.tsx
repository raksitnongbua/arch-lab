...
/**
 * `/view/usecase/[exampleId]` — one registered example use-case diagram,
 * read-only. The use-case counterpart of `/view/[modelId]`,
 * `/view/sequence/[exampleId]` and `/view/flowchart/[exampleId]`, and the
 ...
 * seed alias is the short `/view/uc`: nothing is ever minted against THIS
 * path — it is a crawlable page a human or a search engine follows a link to,
 * so the readable word beats the four characters. `/view/uc` stays the
...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: { canonical: `/view/usecase/${exampleId}` },
  };
}
