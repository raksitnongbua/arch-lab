          ...
          <p className="w-full text-sm leading-relaxed text-muted-foreground sm:w-auto sm:flex-1">
            ...
            {CANVAS_EDIT_ENABLED ? (
              <>
                ...
                and their wording edited in the details panel, and sequence
                messages and lifelines added, edited, repointed, reordered,
                numbered and removed on it; the other kinds lay themselves out
                from the text.{" "}
              </>
            ) : null}
