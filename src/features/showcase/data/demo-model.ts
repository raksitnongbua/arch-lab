/**
 * The showcase model: ShopFlow, the worked example from
 * `docs/product/data-model.md`, extended to cover all four C4 levels with
 * two independent drill paths at Component level.
 *
 *   Context      ShopFlow Platform among its users and third parties
 *   Container    Cloudflare → nginx → Next.js / Kong → two Go services →
 *                PostgreSQL, Redis, MongoDB
 *   Component    inside the Orders Service AND inside the Catalog Service
 *   Code         inside the Orders Service's Checkout Use Case
 *
 * Hand-authored, typed, deep-frozen at module load — the page ships no JSON
 * fetch and nothing the viewer does can mutate it.
 */

import { deepFreeze, diagram, type ShowcaseModel } from "../lib/model";

export const DEMO_MODEL: ShowcaseModel = deepFreeze<ShowcaseModel>({
  ...
  diagrams: {
    ...
    "d-ctx-root": diagram({
      ...
      nodes: [
        ...
        },
        {
          ...
          name: "Ops Engineer",
          description:
            "On-call engineer inspecting order state and replaying failed payments.",
          icon: "person",
          position: { x: 800, y: 80 },
          size: { width: 160, height: 96 },
        },
        {
          ...
          description:
            "Catalogue browsing, cart, checkout, and order fulfilment.",
        ...
        },
        {
          ...
          name: "Warehouse WMS",
          description:
            "Third-party warehouse management system that fulfils shipments.",
          technology: "SFTP / CSV",
          icon: "external",
    ...
    "d-cnt-shopflow": diagram({
      ...
      nodes: [
        ...
        },
        {
          ...
          name: "Edge / CDN",
          description:
            "TLS termination, WAF, bot mitigation, static asset caching.",
        ...
        },
        {
          ...
          name: "Ingress",
          description:
            "Reverse proxy inside the cluster; routes /api to the gateway and everything else to the web app.",
        ...
        },
        {
          ...
          description:
            "Server-rendered storefront: catalogue, cart, checkout flow.",
        ...
        },
        {
          ...
          name: "API Gateway",
          description:
            "Authn/authz enforcement, rate limiting, request routing to internal services.",
        ...
        },
        {
          ...
          name: "Orders Service",
          description:
            "Order lifecycle: create, pay, cancel, fulfil. Owns the order aggregate.",
          technology: "Go 1.22",
          icon: "golang",
        ...
        },
        {
          ...
          description:
            "Orders, payments, and the outbox table. System of record.",
        ...
        },
        {
          ...
          description:
            "Sessions, idempotency keys, gateway rate-limit counters.",
          technology: "Redis 7",
          icon: "redis",
    ...
    /* ----------------------------------- L3 · Components: Orders Service --- */
    "d-cmp-orders": diagram({
      id: "d-cmp-orders",
      level: "component",
      title: "Orders Service — Components",
      description:
        "Internal structure of the Orders Service. Boundary nodes are inherited from the container view.",
      ...
      nodes: [
        ...
        },
        {
          ...
          description:
            "Decodes requests, validates payloads, maps domain errors to status codes.",
        ...
        },
        {
          ...
          description:
            "Orchestrates stock reservation, payment authorisation, and order persistence in one transactional boundary.",
          technology: "Go",
          icon: "golang",
          position: { x: 480, y: 360 },
          size: { width: 176, height: 88 },
          childDiagramId: "d-code-checkout",
        },
        {
          ...
          description:
            "Rejects duplicate checkout attempts by key before any side effect occurs.",
          technology: "Go",
          icon: "service",
        ...
        },
        {
          ...
          name: "Payment Client",
          description:
            "Stripe adapter: retries, webhook signature verification, card data never logged.",
        ...
        },
        {
          ...
          description:
            "Persistence for the order aggregate plus the transactional outbox write.",
          technology: "Go / pgx",
          icon: "service",
        ...
        },
        {
          ...
          name: "Outbox Worker",
          description:
            "Polls the outbox table and dispatches receipt emails and fulfilment events at-least-once.",
          technology: "Go",
          icon: "queue",
        ...
        },
        {
          ...
          size: { width: 176, height: 80 },
          externalRef: {
            diagramId: "d-cnt-shopflow",
            nodeId: "catalog-service",
          },
        },
      ],
      edges: [
    ...
    /* ---------------------------------- L3 · Components: Catalog Service --- */
    "d-cmp-catalog": diagram({
      id: "d-cmp-catalog",
      level: "component",
      title: "Catalog Service — Components",
      description:
        "Internal structure of the Catalog Service. Boundary nodes are inherited from the container view.",
      ownerNodeId: "catalog-service",
      parentDiagramId: "d-cnt-shopflow",
      nodes: [
        {
          id: "ext-kong-cat",
        ...
        {
          id: "catalog-grpc-handler",
          type: "component",
          name: "Catalog gRPC Handler",
          description:
            "ListProducts, GetProduct, SearchFacets, ReserveStock. Thin decode/validate layer.",
          technology: "Go / grpc-go",
          icon: "golang",
        ...
        },
        {
          ...
          name: "Product Query",
          description:
            "Serves product detail and listing reads through a read-through cache.",
          technology: "Go",
          icon: "service",
        ...
        },
        {
          ...
          name: "Facet Search",
          description:
            "Builds search facets and runs filtered listings over denormalised documents.",
          technology: "Go",
          icon: "service",
          position: { x: 664, y: 360 },
          size: { width: 176, height: 88 },
        },
        {
          ...
          description:
            "Holds inventory for in-flight checkouts with a TTL; releases on cancel.",
          technology: "Go",
          icon: "service",
        ...
        },
        {
          ...
          type: "component",
          name: "Cache Adapter",
          description: "Read-through product cache with jittered TTLs.",
          technology: "Go / go-redis",
          icon: "redis",
        ...
        },
        {
          ...
          description:
            "Product documents, facet aggregation pipelines, and inventory counters.",
          technology: "Go / mongo-driver",
          icon: "service",
          position: { x: 528, y: 528 },
          size: { width: 176, height: 88 },
        },
        {
          id: "ext-cache-cat",
        ...
        },
        {
          ...
          size: { width: 176, height: 80 },
          externalRef: { diagramId: "d-cnt-shopflow", nodeId: "catalog-db" },
        },
      ],
      edges: [
        {
          id: "e-kongcat-handler",
          source: "ext-kong-cat",
          target: "catalog-grpc-handler",
          label: "ListProducts, GetProduct, SearchFacets",
          technology: "gRPC",
          direction: "forward",
          realizes: "e-kong-catalog",
        },
        {
          id: "e-orderssvc-reservation",
          source: "ext-orders-svc",
          target: "stock-reservation",
          label: "Reserves stock at checkout",
          technology: "gRPC",
          direction: "forward",
          realizes: "e-orders-catalog",
        ...
        {
          id: "e-cathandler-query",
          source: "catalog-grpc-handler",
          target: "product-query",
          label: "Invokes",
          direction: "forward",
        },
        {
          id: "e-cathandler-facets",
          source: "catalog-grpc-handler",
          target: "facet-search",
          label: "Invokes",
          direction: "forward",
        },
        {
          ...
          target: "cache-adapter",
          label: "Read-through product cache",
          direction: "forward",
        },
        {
          id: "e-cacheadapter-redis",
          source: "cache-adapter",
          target: "ext-cache-cat",
          label: "GET / SETEX product documents",
          technology: "RESP/TCP",
          direction: "bidirectional",
          style: "dashed",
          realizes: "e-catalog-cache",
        },
        {
          id: "e-query-repo",
          source: "product-query",
          target: "catalog-repository",
          label: "Loads product documents",
          direction: "forward",
        },
        {
          id: "e-facets-repo",
          source: "facet-search",
          target: "catalog-repository",
          label: "Runs aggregation pipelines",
          direction: "forward",
        },
        {
          id: "e-reservation-repo",
          source: "stock-reservation",
          target: "catalog-repository",
          label: "Decrements inventory counters",
          direction: "forward",
        },
        {
          id: "e-catrepo-db",
          source: "catalog-repository",
          target: "ext-catalog-db",
          label: "find / aggregate / updateOne",
          technology: "MongoDB wire protocol",
          direction: "bidirectional",
          realizes: "e-catalog-db",
        },
      ],
    }),

    /* --------------------------------------- L4 · Code: Checkout Use Case --- */
    "d-code-checkout": diagram({
      id: "d-code-checkout",
      level: "code",
      title: "Checkout Use Case — Code",
      description:
        "The structs and interfaces that make the checkout transaction real. Level 4 is plain boxes on purpose.",
      ownerNodeId: "checkout-usecase",
      parentDiagramId: "d-cmp-orders",
      nodes: [
        {
          id: "checkout-input",
          type: "codeElement",
          name: "CheckoutInput",
          description:
            "Validated request: cart lines, payment method, idempotency key.",
          technology: "Go struct",
          icon: "golang",
          position: { x: 176, y: 96 },
          size: { width: 192, height: 88 },
        },
        {
          id: "checkout-service",
          type: "codeElement",
          ...
          description:
            "Orchestrates the checkout transaction; the only exported entry point.",
          technology: "Go struct",
          icon: "golang",
          position: { x: 464, y: 96 },
          size: { width: 208, height: 88 },
        },
        {
          id: "checkout-result",
          type: "codeElement",
          name: "CheckoutResult",
          description:
            "Order id, payment status, and reservation expiry returned to the handler.",
          technology: "Go struct",
          icon: "golang",
          position: { x: 760, y: 96 },
          size: { width: 192, height: 88 },
        ...
        {
          id: "payment-authorizer",
          type: "codeElement",
          name: "PaymentAuthorizer",
          description: "Port implemented by the Payment Client adapter.",
        ...
        },
        {
          ...
          type: "codeElement",
          name: "StockReserver",
          description: "Port implemented by the Catalog Service gRPC client.",
          technology: "Go interface",
          icon: "service",
          position: { x: 472, y: 320 },
          size: { width: 192, height: 88 },
        },
        {
          id: "order-writer",
          ...
          name: "OrderWriter",
          description:
            "Port implemented by the Order Repository: order plus outbox record in one transaction.",
          technology: "Go interface",
          icon: "service",
          position: { x: 704, y: 320 },
          size: { width: 192, height: 88 },
        },
      ],
      edges: [
        ...
        {
          id: "e-service-payment",
          source: "checkout-service",
          target: "payment-authorizer",
          label: "Authorises via",
          direction: "forward",
          style: "dashed",
        },
        {
