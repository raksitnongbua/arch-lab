...
export const HEADER_ROWS: readonly HeaderRow[] = [
  ...
  {
    syntax: "direction tb|lr|fit",
    example: "direction fit",
    mapsTo: "direction",
    notes:
      ...
      "shape of a screen instead of a column. `fit` names no direction: the " +
      "diagram is laid out every way — top-down, left-to-right, and top-down " +
      "wrapped into columns — and whichever lands nearest the shape of a " +
      "screen is kept. Only affects nodes whose position the text omits.",
  },
  {
    syntax: "tags #a #b",
