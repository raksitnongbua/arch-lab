 ...
 * exchange.
 *
 * It exists because two routes have to speak for all nine document kinds at
 ...
 * here, without becoming a collage. Nine full miniatures competing for the same
 ...
 * does not scale to nine at 28px in a 620px column, which is why both cards
 * now say "nine notations" and spend the rest of the line on the capability. The
