...
- **A render URL that cannot be drawn answers with a picture that says why**,
  ...
  rather than the model, so it cannot be drawn this way yet — each come back as
  a legible card. The status code still tells the truth for anything reading it.
